...
export default function App() {
  ...
  useEffect(() => {
    try {
      const saved = localStorage.getItem('autoval_history');
  ...
  const saveToHistory = () => {
    ...
    setHistory(updated);
    localStorage.setItem('autoval_history', JSON.stringify(updated));
  ...
  return (
    <div className="app-container">
      ...
      <header className="navbar">
        <div className="brand-section">
          ...
          <div className="brand-titles">
            <div className="brand-name">AutoVal <span>AI</span></div>
                ...
                <div key={item.id} className="history-card">
                  ...
                  <div className="history-footer">
                    ...
                    <button className="history-action-btn delete" onClick={() => {
                      ...
                      setHistory(next);
                      localStorage.setItem('autoval_history', JSON.stringify(next));
                      showToast('Removed');
                    }}>
      ...
      <footer className="app-footer">
        <div>AutoVal AI · Instant Market Price Intelligence for Used Cars in India</div>
        ...
        <div className="modal-backdrop" onClick={() => setShowAbout(false)}>
          <div className="modal-content" onClick={e => e.stopPropagation()}>
            <div className="modal-header">
              <div>
                <h3 style={{ fontSize: '1.2rem', fontWeight: 800, marginBottom: '0.2rem' }}>How AutoVal AI Works</h3>
            ...
            <p style={{ fontSize: '0.86rem', color: 'var(--steel-300)', lineHeight: '1.65' }}>
              AutoVal AI uses an ensemble machine learning model trained on real-world transactional data to estimate fair used car resale values across major Indian cities.
            </p>
